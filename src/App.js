              ...
              >
                ...
                <SideNav.Nav>
                  <NavItem eventKey="inbound" disabled={routeStat}>
                    <NavIcon>
                      <i
                        className="fa fa-fw fa-inbound"
                        style={{ fontSize: '1.75em' }}
                      />
                    </NavIcon>
                    <NavText>Inbound</NavText>
                  </NavItem>
                  <NavItem eventKey="outbound" disabled={routeStat}>
                    <NavIcon>
                      <i
                        className="fa fa-fw fa-outbound"
                        style={{ fontSize: '1.75em' }}
                      />
                    </NavIcon>
                    <NavText>Outbound</NavText>
                  </NavItem>

                  <NavItem eventKey="view" disabled={routeStat}>
                    <NavIcon>
                      <i
                        className="fa fa-fw fa-view"
                        style={{ fontSize: '1.75em' }}
                      />
                    </NavIcon>
                  ...
                  <NavItem eventKey="repairandrep" disabled={routeStat}>
                    <NavIcon>
                      <i
                        className="fa fa-fw fa-repairandrep"
                        style={{ fontSize: '1.75em' }}
                      />
                    </NavIcon>
                    <NavText>Repair and Replacement</NavText>
                  </NavItem>
                </SideNav.Nav>
              </SideNav>
              <main>
