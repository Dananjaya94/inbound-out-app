...
export default class ViewComponent extends Component{
  ...
  componentDidMount()
  {
    axios.get('http://localhost:4000/inbound/')
        .then(data=> {
            this.setState({InboundAllData : data.result});
            console.log(data);
        })
...
// //   objects =[ {
// //     INBOUND_ID: "20200717120734000009",
// //     INBOUND_DATE: "17/07/2020",
// //     INBOUND_DESCRIPTION: "Laptop",
// //     INBOUND_BRANCHORDEPARTMENT: "ACC",
// // INBOUND_HANDOVERUSERNAME: "Irosh",
// // INBOUND_ITOFFICERNAME: "Dilina"
...
render()
{
  //let content = this.renderInboundData(this.state.InboundAllData);
  return(
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-9">
          ...
          <table id="example" className="mdl-data-table" style={{width: "100%"}}>
        <thead>
            <tr>
                <th>Name</th>
                <th>Position</th>
