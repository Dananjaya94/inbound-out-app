...
export default class OutboundComp extends Component {
  constructor(props) {
    super(props);
    this.onchange_outbound_Item_Description = this.onchange_outbound_Item_Description.bind(
      this
    );
    this.onchange_outbound_Serial_No = this.onchange_outbound_Serial_No.bind(
      this
    );
    this.onchange_outbound_Dept_Branch = this.onchange_outbound_Dept_Branch.bind(
      this
    );
    this.onchange_outbound_Handover_Username = this.onchange_outbound_Handover_Username.bind(
      this
    );
    this.onchange_outbound_It_Officername = this.onchange_outbound_It_Officername.bind(
      this
    );
    this.onchange_outbound_epf_no = this.onchange_outbound_epf_no.bind(this);
    this.onchange_outbound_it_officer_id = this.onchange_outbound_it_officer_id.bind(
      this
    );
  ...
  renderOutboundData(OutBoundDT) {
    let tableContent =
      OutBoundDT === undefined || OutBoundDT === null || OutBoundDT.length === 0
        ? null
  ...
  onSubmit(e) {
    ...
    axios
      .post('http://localhost:4000/outbound/add', AddingOutBound)
            ...
            <div style={{ margin: 20 }}>
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">Outbound date :</div>
                </div>
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    <input
                      ...
                      value={this.state.outbound_Item_Description}
                      onChange={this.onchange_outbound_Item_Description}
                    ></input>
                  </div>
                </div>
              </div>
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">Serial No :</div>
                </div>
                <div className="col-md-4">
                  <div className="form-group">
                    <Autocomplete
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">Dept/Branch Code:</div>
                </div>
                <div className="col-md-4">
                  <div className="form-group">
                    <Autocomplete
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">Hand over User Name :</div>
                </div>
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    <input
                      ...
                      type="text"
                      className="form-control"
                      value={this.state.outbound_Handover_Username}
                      onChange={this.onchange_outbound_Handover_Username}
                    ></input>
                  </div>
                </div>
              </div>
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">Hand Over User EPF :</div>
                </div>
                <div className="col-md-4">
                  <div className="form-group">
                    <input
                      ...
                      type="text"
                      className="form-control"
                      value={this.state.outbound_epf_no}
                      onChange={this.onchange_outbound_epf_no}
                    ></input>
                  </div>
                </div>
              </div>
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">IT Officer Name :</div>
                </div>
                <div className="col-md-4">
                  <div className="form-group">
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">IT Officer ID :</div>
                </div>
                <div className="col-md-4">
                  <div className="form-group">
                    {/* <input type="text" ></input>  */}
                    <input
                      ...
                      type="text"
                      className="form-control"
                      value={this.state.outbound_it_officer_id}
                      onChange={this.onchange_outbound_it_officer_id}
                    ></input>
                  </div>
                </div>
              </div>
          ...
          <div className="rightside">
            ...
            <div className="row">
              <div className="col-md-11">
                ...
                <a
                  href={
                    'http://10.10.1.220/repair/homerep.aspx?uname=' +
                    usr +
                    '&pwd=' +
                    pw
                  }
