...
$(document).ready(function () {
  ...
  $('#tbloutbound1').on('click', 'tr', function () {
    ...
    newInbound = {
      asset_out_id: col1,
      asset_rec_date: f.toLocaleDateString('en-GB', {
        day: 'numeric',
        month: 'short',
        year: 'numeric',
      }),
...
export default class inbound extends Component {
  constructor(props) {
    ...
    this.onchange_asset_branch_code = this.onchange_asset_branch_code.bind(
      this
    );
    this.onchange_asset_tracking_num = this.onchange_asset_tracking_num.bind(
      this
    );
    this.onchange_asset_description = this.onchange_asset_description.bind(
      this
    );
    this.onchange_asset_reciever_epf = this.onchange_asset_reciever_epf.bind(
      this
    );
    this.onchange_asset_reciever_name = this.onchange_asset_reciever_name.bind(
      this
    );
    this.onchange_asset_it_officer_name = this.onchange_asset_it_officer_name.bind(
      this
    );
    this.onchange_asset_it_officer_epf = this.onchange_asset_it_officer_epf.bind(
      this
    );
    this.onchange_asset_recieved_location = this.onchange_asset_recieved_location.bind(
      this
    );
  ...
  componentDidMount() {
    axios
      .get('http://localhost:4000/outbound/')
      .then((data) => {
  ...
  onChangeDate = (asset_recieved_date) =>
    this.setState({ asset_recieved_date });
  ...
  onSubmit(e) {
    ...
    axios
      .post('http://localhost:4000/inbound/add', newInbound)
  ...
  render() {
    ...
    const LoginContainer = () => window.location.reload(false);
          ...
          <div className="col-md-2">
            <div className="form-group">
              <DatePicker
                ...
                value={this.state.asset_rec_date}
                timezone={'SL/Asia'}
              ></DatePicker>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="form-group">
              <input
                ...
                onChange={this.onchange_asset_description}
              ></input>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-2">
            <div className="form-group">
              <input
                ...
                type="text"
                className="form-control"
                value={this.state.asset_seq_no}
                onChange={this.onchange_asset_seq_no}
              ></input>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="form-group">
              <input
                ...
                type="text"
                className="form-control"
                value={this.state.asset_branch_code}
                onChange={this.onchange_asset_branch_code}
              ></input>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-2">
            <div className="form-group">
              <input
                ...
                type="text"
                className="form-control"
                value={this.state.asset_reciever_name}
                onChange={this.onchange_asset_reciever_name}
              ></input>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="form-group">
              <input
                ...
                type="text"
                className="form-control"
                value={this.state.asset_reciever_epf}
                onChange={this.onchange_asset_reciever_epf}
              ></input>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-2">
            <div className="form-group">
              <input
                ...
                type="text"
                className="form-control"
                value={this.state.asset_it_office_name}
                onChange={this.onchange_asset_it_officer_name}
              ></input>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="form-group">
              <input
                ...
                type="text"
                className="form-control"
                value={this.state.asset_it_office_epf}
                onChange={this.onchange_asset_it_officer_epf}
              ></input>
        ...
        <div className="row">
          ...
          <div className="col-md-2">
            <input
              ...
              type="text"
              className="form-control"
              value={this.state.asset_out_id}
              onChange={this.onChange_asset_outid}
            ></input>
          </div>
          <div className="col-md-2"></div>
          <div className="col-md-2">
